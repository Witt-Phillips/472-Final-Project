...
def main():
    ...
    while robot.step(TIME_STEP) != -1:
        ...
        # code for estimating orientation change

        # USE VELOCITY TO ESTIMATE ORIENTATION CHANGE
        fl_velocity = fl.getVelocity()
        bl_velocity = fr.getVelocity()
        average_left_velocity = (fl_velocity + bl_velocity) / 2.0

        fr_velocity = fr.getVelocity()
